...
import { Bot, Landmark, MessageSquare, Mic, MicOff, Navigation, Sparkles, Volume2 } from 'lucide-react';
...
export default function VoicePanel({
  ...
  return (
    <div className="relative flex h-full w-1/2 flex-col items-center justify-between border-r border-zinc-900 bg-gradient-to-b from-zinc-950 to-zinc-900/40 p-10">
      {activeQrCode && (
      ...
      <div className="relative z-10 my-auto flex w-full items-center justify-center">
        ...
        <div className="absolute flex size-[160px] flex-col items-center justify-center rounded-full border border-zinc-900 bg-zinc-950 shadow-[inset_0_4px_20px_rgba(0,0,0,0.95)]">
      ...
      <div className="relative z-20 flex min-h-[200px] w-full flex-col items-center justify-end gap-3">
